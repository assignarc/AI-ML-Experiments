...
## Exercises
- [ColorPixelTheory](./ColorPixelTheory/README.md)
- [Problem Statement](./Monkeys/README.md)
- [Edge Detection and Kernels](./EdgeDetection/README.md)
- [Working with Images using OpenCV](./OpenCV/README.md)
