# W21-ConvolultionalNeuralNetworks
...
## Exercises
- [MNIST Handwritten Digit Classification using a CNN](./Sequential/README.md)
- [Brain Tumor Image Classifier](./TransferLearning/README.md)
- [Problem Statement](./TransferLearning-Monkeys/README.md)
